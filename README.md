...
Commands used to create database and tables.
...
CREATE TABLE "comments" (
	...
	"book_id"	INTEGER NOT NULL,
	"reader_id"	INTEGER NOT NULL,
	FOREIGN KEY("book_id") REFERENCES "book"("book_id") book_id,
	FOREIGN KEY("reader_id") REFERENCES "reader"("reader_id") book_id
);
```
